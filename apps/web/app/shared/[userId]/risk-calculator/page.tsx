...
import "@/app/(dashboard)/risk-calculator/risk.css";
...
export default function SharedRiskCalculatorPage() {
  const params = useParams();
  const userId = typeof params?.userId === "string" ? params.userId : undefined;
  
  const engine = useRiskEngine(userId);
    ...
    <div className="max-w-[1600px] mx-auto pb-12">
      ...
      <div className="w-full">
        ...
        {hasTemplates && !isCalculatorOpen && (
          <div className="mb-8">
            <RiskTemplates templates={engine.state.savedTemplates} actions={engine.actions} isShared={true} />
          </div>
        )}
